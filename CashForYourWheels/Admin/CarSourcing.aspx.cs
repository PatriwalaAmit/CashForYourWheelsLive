...
{
    public partial class CarSourcing : BasePage
    {
        ...
        protected string setRuleDescription(object PostCode, object PhoneNumber, object EmailAddress)
        {
            return "Post Code: " + Convert.ToString(PostCode) + " <br> Phone Number: " + Convert.ToString(PhoneNumber) + " <br> Email Address: " + Convert.ToString(EmailAddress);
        }
