<%@ Page Language="C#" MasterPageFile="~/Master/AdminPanel.master" AutoEventWireup="true" Inherits="Admin_CMS" Title="Content Management" Codebehind="CMS.aspx.cs" %>
    ...
    <table cellpadding="0" cellspacing="0" width="100%" class="">
        <tr>
            <td class="table_td_left" colspan="2">
                <asp:Label ID="Label7" runat="server" Text="Content Management" CssClass="Link_Label_Bold">
                </asp:Label>
            </td>
        </tr>
        <tr>
            ...
            <td class="table_td_left" colspan="2">
                <table class="Table_Border_Black" cellspacing="0" cellpadding="0" width="100%">
                    <tbody>
                        <tr>
                            <th scope="colgroup">
                                <asp:Label ID="Label4" runat="server" CssClass="label_blackbold10" Text="Add Content"></asp:Label>
                            </th>
                        </tr>
                        <tr>
                            <td class="table_td_left">
                                <table cellspacing="10" cellpadding="0" width="100%" class="">
                                    <tbody>
                                        <tr>
                                            <td class="table_td_left">
                                                <asp:Label ID="Label2" runat="server" CssClass="label" Text="Link Name:"></asp:Label>
                                            </td>
                                            <td class="table_td_left">
                                                <asp:TextBox ID="txtLink" runat="server" CssClass="textbox">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <FCKEd:FCKeditor ID="txtDesc" runat="server" Width="100%" Height="350px" 
                                                    BasePath="/">
                                                </FCKEd:FCKeditor>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="table_td_center" colspan="2">
                                                <%--<asp:ImageButton ID="imgbtn_Insert" OnClick="imgbtn_Insert_Click" runat="server"
                                                    ValidationGroup="AddCategory" CausesValidation="true" OnClientClick="return CheckParent();"
                                                    ImageUrl="~/Images/save_orange.gif"></asp:ImageButton>--%>
        ...
        <tr>
            <td class="table_td_left" colspan="2">
                <cc1:CustomePagingGrid ID="gvAdminList" runat="server" Width="100%" CssClass="gridview"
                    ...
                    DataKeyNames="CMSId" AllowSorting="True" OnSorting="gvAdminList_Sorting" EnableViewState="true"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="LinkName" HeaderText="Title" SortExpression="LinkName">
                        ...
                        <asp:TemplateField HeaderText="Edit" ShowHeader="False">
                            ...
                            <itemtemplate>
                                <asp:LinkButton ID="btnEdit" runat="server" CausesValidation="False" CommandName="ViewDetails"
                                    CommandArgument='<%# Bind("CMSId") %>' Text="Edit"></asp:LinkButton>
                            </itemtemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="AdminId" Visible="false">
                            ...
                            <itemtemplate>
                                <asp:Label ID="lblGetId" runat="server" Text='<%# Bind("CMSId") %>'></asp:Label>
                            </itemtemplate>
                            <itemstyle width="5%" />
                        </asp:TemplateField>
                    </Columns>
    ...
    <script language="javascript" type="text/javascript">
         ...
         function fnCheckAll()
        {
         ...
         function fnClearAll()
         {
          ...
          {
            if(document.getElementById('<%= this.txtLink.ClientID %>').value=='')
            {
                document.getElementById('<%= this.txtLink.ClientID %>').style.backgroundColor='lemonchiffon';
