...
namespace CashForYourWheels.CarwebService {
    using System;
    ...
    public partial class CarweBVRRWebService : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        private System.Threading.SendOrPostCallback strVRRGetVehicleOperationCompleted;
        ...
        public CarweBVRRWebService() {
            this.Url = global::CashForYourWheels.Properties.Settings.Default.CashForYourWheels_CarwebService_CarweBVRRWebService;
        ...
        /// <remarks/>
        public event strVRRGetVehicleCompletedEventHandler strVRRGetVehicleCompleted;
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://ws.carwebuk.com/strVRRGetVehicle", RequestNamespace="http://ws.carwebuk.com", ResponseNamespace="http://ws.carwebuk.com", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        public System.Xml.XmlNode strVRRGetVehicle(string strUserName, string strPassword, string strClientRef, string strClientDescription, string strKey1, string strKey2, string strVRM, string strVIN, string strVersion) {
            object[] results = this.Invoke("strVRRGetVehicle", new object[] {
                        strUserName,
                        strPassword,
                        strClientRef,
                        strClientDescription,
        ...
        /// <remarks/>
        public void strVRRGetVehicleAsync(string strUserName, string strPassword, string strClientRef, string strClientDescription, string strKey1, string strKey2, string strVRM, string strVIN, string strVersion) {
            this.strVRRGetVehicleAsync(strUserName, strPassword, strClientRef, strClientDescription, strKey1, strKey2, strVRM, strVIN, strVersion, null);
        }
        
        /// <remarks/>
        public void strVRRGetVehicleAsync(string strUserName, string strPassword, string strClientRef, string strClientDescription, string strKey1, string strKey2, string strVRM, string strVIN, string strVersion, object userState) {
            if ((this.strVRRGetVehicleOperationCompleted == null)) {
                this.strVRRGetVehicleOperationCompleted = new System.Threading.SendOrPostCallback(this.OnstrVRRGetVehicleOperationCompleted);
            }
            this.InvokeAsync("strVRRGetVehicle", new object[] {
                        strUserName,
                        strPassword,
                        strClientRef,
                        strClientDescription,
                        ...
                        strVRM,
                        strVIN,
                        strVersion}, this.strVRRGetVehicleOperationCompleted, userState);
        }
        
        private void OnstrVRRGetVehicleOperationCompleted(object arg) {
            if ((this.strVRRGetVehicleCompleted != null)) {
                System.Web.Services.Protocols.InvokeCompletedEventArgs invokeArgs = ((System.Web.Services.Protocols.InvokeCompletedEventArgs)(arg));
                this.strVRRGetVehicleCompleted(this, new strVRRGetVehicleCompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState));
            }
        }
    ...
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.0.30319.17929")]
    public delegate void strVRRGetVehicleCompletedEventHandler(object sender, strVRRGetVehicleCompletedEventArgs e);
    
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.0.30319.17929")]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    public partial class strVRRGetVehicleCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
        
        private object[] results;
        
        internal strVRRGetVehicleCompletedEventArgs(object[] results, System.Exception exception, bool cancelled, object userState) : 
                base(exception, cancelled, userState) {
            this.results = results;
        }
