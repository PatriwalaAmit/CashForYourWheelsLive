<%@ Page Title="" Language="C#" MasterPageFile="~/Master/AdminPanel.master" AutoEventWireup="true" Inherits="Admin_location" Codebehind="location.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
                ...
                <table cellpadding="0" cellspacing="0" width="100%" style="height: 25px" class="Table_Bck1">
                    <tr>
                        <td class="table_td_left">
                            <asp:Label ID="Label1" runat="server" Text="Content Management" CssClass="Table_Title_Label_White">
                            </asp:Label>
                        </td>
                    </tr>
                </table>
    ...
    <table cellpadding="0" cellspacing="0" width="100%" class="">
        <tr>
            <td class="table_td_left" colspan="2">
                <asp:Label ID="Label7" runat="server" Text="Location Management" CssClass="Link_Label_Bold">
                </asp:Label>
            </td>
        </tr>
        <tr>
            ...
            <td class="table_td_left" colspan="2">
                <table class="Table_Border_Black" cellspacing="0" cellpadding="0" width="100%">
                    <tbody>
                        <tr>
                            <th scope="colgroup">
                                <asp:Label ID="Label4" runat="server" CssClass="label_blackbold10" Text="Add Location"></asp:Label>
                            </th>
                        </tr>
                        <tr>
                            <td class="table_td_left">
                                <table cellspacing="10" cellpadding="0" width="100%" class="">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="table_td_left">
                                                <asp:TextBox ID="txtLocationName" runat="server" CssClass="textbox">
                                                </asp:TextBox>&nbsp;<span class="red">*</span>
                                                <asp:RequiredFieldValidator ID="rfvLocatioName" runat="server" Display="Dynamic" Text="Please enter" ControlToValidate="txtLocationName" ValidationGroup="addrecord"></asp:RequiredFieldValidator>
                                            </td>
                                        </tr>
                                          <tr>
                                            <td class="table_td_left">
                                                <asp:Label ID="Label5" runat="server" CssClass="label" Text="Location Details:"></asp:Label>
                                            </td>
                                            <td class="table_td_left"> 
                                                <asp:TextBox ID="txtLocationdetails" runat="server" CssClass="textbox" Height="40px">
                                                </asp:TextBox>&nbsp;<span class="red">*</span>
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" Display="Dynamic" Text="Please enter" ControlToValidate="txtLocationdetails" ValidationGroup="addrecord"></asp:RequiredFieldValidator>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="table_td_left">
                                                <asp:Label ID="Label6" runat="server" CssClass="label" Text="Phone Number:"></asp:Label>
                                            </td>
                                            <td class="table_td_left">
                                                <asp:TextBox ID="txtPhoneNumber" runat="server" CssClass="textbox">
                                                </asp:TextBox>&nbsp;<span class="red">*</span>
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" Display="Dynamic" Text="Please enter" ControlToValidate="txtPhoneNumber" ValidationGroup="addrecord"></asp:RequiredFieldValidator>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="table_td_left">
                                                <asp:Label ID="Label8" runat="server" CssClass="label" Text="Cell Number:"></asp:Label>
                                            </td>
                                            <td class="table_td_left">
                                                <asp:TextBox ID="txtCellNumber" runat="server" CssClass="textbox">
                                                </asp:TextBox>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="table_td_left">
                                                <asp:Label ID="Label9" runat="server" CssClass="label" Text="Email Address:"></asp:Label>
                                            </td>
                                            <td class="table_td_left">
                                                <asp:TextBox ID="txtEmailAddress" runat="server" CssClass="textbox">
                                                </asp:TextBox>&nbsp;<span class="red">*</span>
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" Display="Dynamic" Text="Please enter" ControlToValidate="txtEmailAddress" ValidationGroup="addrecord"></asp:RequiredFieldValidator>
                                            </td>
        ...
        <tr>
            <td class="table_td_left" colspan="2">
                <cc1:CustomePagingGrid ID="gvAdminList" runat="server" Width="100%" CssClass="gridview"
                    ...
                    DataKeyNames="LocationId" AllowSorting="True" OnSorting="gvAdminList_Sorting" EnableViewState="true"
                    OnRowCommand="gvAdminList_RowCommand" OnPageIndexChanging="gvAdminList_PageIndexChanging">
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Edit" ShowHeader="False">
                            ...
                            <itemtemplate>
                                <asp:LinkButton ID="btnEdit" runat="server" CausesValidation="False" CommandName="ViewDetails"
                                    CommandArgument='<%# Bind("LocationId") %>' Text="Edit"></asp:LinkButton>
                            </itemtemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="AdminId" Visible="false">
                            ...
                            <itemtemplate>
                                <asp:Label ID="lblGetId" runat="server" Text='<%# Bind("LocationId") %>'></asp:Label>
                            </itemtemplate>
                            <itemstyle width="5%" />
                        </asp:TemplateField>
                    </Columns>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function CheckParent() {
            ...
            //if (document.getElementById('<%= this.txtLocationName.ClientID %>').value == '') {
            //    document.getElementById('<%= this.txtLocationName.ClientID %>').style.backgroundColor = 'lemonchiffon';
