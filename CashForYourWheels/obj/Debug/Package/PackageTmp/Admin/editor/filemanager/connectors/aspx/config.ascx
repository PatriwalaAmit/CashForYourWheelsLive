...
<script runat="server">
	...
	public override void SetConfig()
	{
        ...
        //UserFilesPath = Server.MapPath("~/Upload").ToString().Replace("\\", "/");
		...
		TypeConfig[ "Image" ].FilesPath					= "%UserFilesPath%EditorImages/";
		TypeConfig[ "Image" ].FilesAbsolutePath			= ( UserFilesAbsolutePath == "" ? "" : "%UserFilesAbsolutePath%EditorImages/" );
