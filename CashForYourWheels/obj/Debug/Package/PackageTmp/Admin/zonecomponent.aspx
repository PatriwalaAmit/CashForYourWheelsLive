<%@ Page Title="" Language="C#" MasterPageFile="~/Master/AdminPanel.master" AutoEventWireup="true" Inherits="zonecomponent" Codebehind="zonecomponent.aspx.cs" %>
                ...
                <table cellpadding="0" cellspacing="0" width="100%" style="height: 25px" class="Table_Bck1">
                    <tr>
                        <td class="table_td_left">
                            <asp:Label ID="Label1" runat="server" Text="Zone Component Management" CssClass="Table_Title_Label_White">
                            </asp:Label>
                        </td>
                    </tr>
                </table>
    ...
    <table cellpadding="0" cellspacing="0" width="100%" class="">
        <tr>
            <td class="table_td_left" colspan="2">
                <asp:Label ID="Label7" runat="server" Text="Zone Component Management" CssClass="Link_Label_Bold">
                </asp:Label>
            </td>
        </tr>
        <tr>
                            ...
                            <td class="table_td_left">
                                <table cellspacing="10" cellpadding="0" width="100%" class="">
                                    <tbody>
                                        <tr>
                                            <td class="table_td_left">
                                                <asp:Label ID="Label2" runat="server" CssClass="label" Text="Zone Component Name:"></asp:Label>
                                            </td>
                                            <td class="table_td_left">
                                        ...
                                        <tr>
                                            <td class="table_td_left">
                                                <asp:Label ID="Label3" runat="server" CssClass="label" Text="Zone Name:"></asp:Label>
                                            </td>
                                            <td class="table_td_left">
                                                <asp:DropDownList ID="ddlZoneName" runat="server"></asp:DropDownList>
                                                &nbsp;<span class="red">*</span>
                                            </td>
                                        </tr>                                        
                                        <tr>
        ...
        <tr>
            <td class="table_td_left" colspan="2">
                <cc1:CustomePagingGrid ID="gvAdminList" runat="server" Width="100%" CssClass="gridview"
                    ...
                    DataKeyNames="ZonecomponentId" AllowSorting="True" OnSorting="gvAdminList_Sorting" EnableViewState="true"
                    ...
                    <Columns>
                        <asp:TemplateField>
                         ...
                         <asp:BoundField DataField="ZoneComponentName" HeaderText="Component Name" SortExpression="ZoneComponentName">
                        ...
                        <asp:TemplateField HeaderText="Edit" ShowHeader="False">
                            ...
                            <itemtemplate>
                                <asp:LinkButton ID="btnEdit" runat="server" CausesValidation="False" CommandName="ViewDetails"
                                    CommandArgument='<%# Bind("ZonecomponentId") %>' Text="Edit"></asp:LinkButton>
                            </itemtemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="AdminId" Visible="false">
                            ...
                            <itemtemplate>
                                <asp:Label ID="lblGetId" runat="server" Text='<%# Bind("ZonecomponentId") %>'></asp:Label>
                            </itemtemplate>
                            <itemstyle width="5%" />
                        </asp:TemplateField>
                    </Columns>
