<%@ Page Language="C#" MasterPageFile="~/Master/AdminPanel.master" AutoEventWireup="true" Inherits="Admin_whitelistips" Title="Whitelist IPs" Codebehind="whitelistips.aspx.cs" %>
    ...
    <table cellpadding="0" cellspacing="0" width="100%" class="">
        <tr>
            <td class="table_td_left" colspan="2">
                <asp:Label ID="Label7" runat="server" Text="White list IP Management" CssClass="Link_Label_Bold">
                </asp:Label>
            </td>
        </tr>
        <tr>
            ...
            <td class="table_td_left" colspan="2">
                <table class="Table_Border_Black" cellspacing="0" cellpadding="0" width="100%">
                    <tbody>
                        <tr>
                            <th scope="colgroup">
                                <asp:Label ID="Label4" runat="server" CssClass="label_blackbold10" Text="Add IP"></asp:Label>
                            </th>
                        </tr>
                        <tr>
                            <td class="table_td_left">
                                <table cellspacing="10" cellpadding="0" width="100%" class="">
                                    <tbody>
                                        <tr>
                                            <td class="table_td_left">
                                                <asp:Label ID="Label2" runat="server" CssClass="label" Text="IP Address:"></asp:Label>
                                            </td>
                                            <td class="table_td_left">
        ...
        <tr>
            <td class="table_td_left">
                <asp:Label ID="lblsearch2" runat="server" CssClass="label_blackbold10" Text="IP List"></asp:Label>
            </td>
        ...
        <tr>
            <td class="table_td_left" colspan="2">
                <cc1:CustomePagingGrid ID="gvAdminList" runat="server" Width="100%" CssClass="gridview"
                    ...
                    DataKeyNames="Id" AllowSorting="True" OnSorting="gvAdminList_Sorting" EnableViewState="true"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="AdminId" Visible="false">
                            ...
                            <itemtemplate>
                                <asp:Label ID="lblGetId" runat="server" Text='<%# Bind("Id") %>'></asp:Label>
                            </itemtemplate>
                            <itemstyle width="5%" />
                        </asp:TemplateField>
                    </Columns>
